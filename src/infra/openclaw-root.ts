...
// StonkAgents: also accept the npm names our fork is published under
// ("stonkagents") so the package-root resolver works
// from an npm install dir. Without this, the root resolver walks past the npm
// install dir, falls back to CWD, and breaks workspace template loading on
// installer-driven onboarding.
const CORE_PACKAGE_NAMES = new Set(["openclaw", "stonkagents"]);
